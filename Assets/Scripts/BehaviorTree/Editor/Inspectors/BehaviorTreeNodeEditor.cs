...
namespace Benco.BehaviorTree
{
    ...
    [CustomEditor(typeof(NodeBehaviorTree), true)]
    public class BehaviorTreeNodeEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginVertical();
            {
                ...
                newSharedVariableTypeIndex = EditorGUILayout.Popup(newSharedVariableTypeIndex, BehaviorTreeUtilities.validTypeOptions);
                ...
                if (GUILayout.Button(new GUIContent("Add Variable", "Add Variable")))
                {
                    ...
                    {
                        graph.sharedVariableCollection.AddVariable(newSharedVariableName, BehaviorTreeUtilities.validTypes[newSharedVariableTypeIndex]);
                    }
                }
            }
            EditorGUILayout.EndVertical();
